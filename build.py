...
TECH = [  # slug, lead, [(technology, what it is)], applications, photo alt  — Technology copy per Bennett, chat 2026-09-15 (see COPY-SOURCES.md)
 ("acoustics","MW Acoustics is where the group’s technology meets the listener — every division’s work, applied to consumer products you can hear.",
  [("Magnet topologies","Each MW Acoustics line is defined by its magnet system — neodymium, ferrite, alnico and field coil. The Neo line launches on proven motors from an established driver manufacturer, with MW Magnetics’ motor research informing the lines that follow."),
   ...
   ("Manufacturing","CNC machining, precision assembly and the advanced global manufacturing partners developed through MW Heavy."),
 ...
 ("deeplearning","To improve efficiency and precision in our own processes, we had to develop AI tools and workflows that could design, optimize and scale our innovations.",
  [("BRiDG™","AI-optimized manufacturing: an AI software hub leveraging LLM agents that augment existing manufacturing workflows and automate complex engineering challenges."),
   ...
   ("Alignment","Research into AI systems that stay safe, predictable and accountable as they scale."),
   ("Computational storage","Moving computation to where the data lives, cutting the cost and energy of large-scale AI."),
   ("Beyond transformers","Next-generation model architectures outside the transformer paradigm. We are looking to the future to design scalable, cost-effective and safe AI."),
 ...
 ("heavy","Industrial Scale Solutions.",
  [("Industrial engineering","Engineering for demanding physical applications, drawing on the group’s magnetics, composites and additive technologies."),
   ("Precision machining","CNC machining and large-format fabrication — the same techniques that cut MW Acoustics’ aluminum horns and lenses."),
   ("Global manufacturing partners","An advanced, vetted network of manufacturing partners for production at industrial scale.")],
...
def shell(title, body, current=None, desc="MeierWerks. Where the hand of craft meets the precision of technology."):
...
<div class="grid"><h1>Where the hand of craft meets the precision of technology.</h1>
...
<section class="band-black tight"><div class="wrap wrks"><p class="poweredby"><img class="pb-text" src="assets/logos/powered-by-white.svg" alt="Powered by"><img class="pb-logo" src="assets/logos/wrks-color.svg" alt="WRKS"></p><p class="wrks-caption">WRKS is a collection of proprietary physics and simulation engines, built into our software and services.</p></div></section>
'''
# ---------- Divisions ----------
def plain_tiles():
