...
- 2026-09-15: Technology page rewritten to Bennett's chat brief: MW Acoustics = the showcase where the other divisions' technology is applied to consumer products (magnetic motor systems; lens/horn redesigned with FEA, CFD and deep-learning simulation and CNC-cut; nested cylindrical transmission line that beats rectangular/square lines; additive + composite structures; CNC and global partners via MW Heavy). ISo-TL™ and SONIFoRM™ (automated dispersion) removed — "there is no ISO TL anymore", "automated dispersion is not an actual thing yet". Other divisions' Applications now name non-audio industries (automotive / Formula One, aerospace, defense, marine, energy…). Additive: "sovereign, deployable, secure slicing on any hardware". Deep Learning: alignment, computational storage, AI beyond transformer models — "scalable, cost-effective and safe AI". Wording drafted by Claude from Bennett's brief; Bennett to strike anything overstated.
- 2026-09-15: Technology › MW Acoustics motor entry softened per Bennett: the Neo line uses third-party motors from an established driver manufacturer (not built in-house or jointly), so the entry now says so and positions MW Magnetics' research as informing later lines. Manufacturer not named.
- 2026-09-15: Partners › NVIDIA Inception card now carries the official NVIDIA Inception Program member badge (NVIDIA's "badge RGB for screen" file, as distributed to members; obtained from a member site's re-host of the file) in place of the corporate NVIDIA logo. Bennett, chat.
- 2026-09-15: Technology › MW Additive photo replaced (Bennett: old one "generic and boring", wants defense/military additive manufacturing). New image = U.S. Air Force photo "31st MXS metals shop new 3D printing capability will save man hours, money" (31st Maintenance Squadron, Aviano AB; DVIDS 8529140, via Wikimedia Commons), a U.S. Government work in the PUBLIC DOMAIN — no credit required. Cropped to gloves + printer so no face/name tape is shown. DoD imagery does not imply DoD endorsement.
- 2026-09-15: Every WRKS lockup is now the words "Powered by" + the WRKS colour logo (no separate WRKS logo above a "Powered by WRKS" line, and the "POWERED BY WRKS" lockup artwork is retired). Caption everywhere: "WRKS is a collection of proprietary physics and simulation engines, built into all of our software." Bennett, chat.
- 2026-09-15: Technology › MW Additive photo replaced again (Bennett: the USAF metals-shop image was not actually 3D printing). Now: U.S. Marine Corps photo "U.S. Marines bring advanced manufacturing to the front lines during Valiant Shield 26" (DVIDS 9821830, via Wikimedia Commons) — a Marine holding a freshly printed part on its build plate. U.S. Government work, PUBLIC DOMAIN, no credit required; not DoD endorsement.
- 2026-09-15: Home hero = Bennett's own drone footage "Evening Mist v1.m4v" (Desktop, 2026-09-13; Kent CT at dusk), cut to a 17 s cross-faded loop (source 1.5–18.5 s, 1.5 s fade), 1080p H.264 ~2.6 Mbps, muted, autoplay, playsinline; poster = first frame. Hidden on ≤600 px and for prefers-reduced-motion (poster shows). Bennett, chat ("ok go").
